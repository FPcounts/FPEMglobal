...
+------------------------------+----------------------------------------+----------------------------------------------------------+
| Output folder path           | `do_global_run`                        | `age_ratios_age_total_run_dir_path`                |
+------------------------------+----------------------------------------+----------------------------------------------------------+
|                              | `do_global_all_women_run`              | `age_ratios_age_total_married_run_dir_path`        |
...
+=======================+=================================================+=================================================================================+
| Married and unmarried | Age ratios, country level                       | `post_process_mcmc(..., age_ratios_age_total_run_dir_path = "NAME")` \    | 
|                       |                                                 | `make_results`                                                                  |
+-----------------------+-------------------------------------------------+---------------------------------------------------------------------------------+
...
+-----------------------+-------------------------------------------------+---------------------------------------------------------------------------------+
| All women             | Age ratios, country level                       | `combine_runs(..., age_ratios_age_total_run_dir_path = "NAME")` \         |
|                       |                                                 | `make_results`                                                                  |
+-----------------------+-------------------------------------------------+---------------------------------------------------------------------------------+
|                       | Age ratios, std. aggregates                     | `combine_runs(..., age_ratios_age_total_run_dir_path = "NAME")` \         |
|                       |                                                 | `make_results`                                                                  |
+-----------------------+-------------------------------------------------+---------------------------------------------------------------------------------+
|                       | Age ratios, spec. aggregates                    | `combine_runs(..., age_ratios_age_total_run_dir_path = "NAME")` \         |
